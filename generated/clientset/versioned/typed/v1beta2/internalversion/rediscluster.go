...
func newRedisClusters(c *V1beta2Client, namespace string) *redisClusters {
...
func (c *redisClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.RedisCluster, err error) {
	result = &v1beta2.RedisCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *redisClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.RedisClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.RedisClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redisclusters").
...
func (c *redisClusters) Create(ctx context.Context, redisCluster *v1beta2.RedisCluster, opts v1.CreateOptions) (result *v1beta2.RedisCluster, err error) {
	result = &v1beta2.RedisCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redisclusters").
...
func (c *redisClusters) Update(ctx context.Context, redisCluster *v1beta2.RedisCluster, opts v1.UpdateOptions) (result *v1beta2.RedisCluster, err error) {
	result = &v1beta2.RedisCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redisclusters").
...
func (c *redisClusters) UpdateStatus(ctx context.Context, redisCluster *v1beta2.RedisCluster, opts v1.UpdateOptions) (result *v1beta2.RedisCluster, err error) {
	result = &v1beta2.RedisCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redisclusters").
...
func (c *redisClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.RedisCluster, err error) {
	result = &v1beta2.RedisCluster{}
