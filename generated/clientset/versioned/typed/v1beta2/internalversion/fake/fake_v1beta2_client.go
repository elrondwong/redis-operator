...
import (
	internalversion "github.com/elrondwong/redis-operator/generated/clientset/versioned/typed/v1beta2/internalversion"
...
func (c *FakeV1beta2) RedisReplications(namespace string) internalversion.RedisReplicationInterface {
	return &FakeRedisReplications{c, namespace}
}
