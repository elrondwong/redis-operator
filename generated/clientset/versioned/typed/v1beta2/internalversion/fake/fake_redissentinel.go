...
var redissentinelsResource = v1beta2.SchemeGroupVersion.WithResource("redissentinels")

var redissentinelsKind = v1beta2.SchemeGroupVersion.WithKind("RedisSentinel")
...
func (c *FakeRedisSentinels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.RedisSentinel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(redissentinelsResource, c.ns, name), &v1beta2.RedisSentinel{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta2.RedisSentinel), err
}
...
func (c *FakeRedisSentinels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.RedisSentinelList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(redissentinelsResource, redissentinelsKind, c.ns, opts), &v1beta2.RedisSentinelList{})
	...
	list := &v1beta2.RedisSentinelList{ListMeta: obj.(*v1beta2.RedisSentinelList).ListMeta}
	for _, item := range obj.(*v1beta2.RedisSentinelList).Items {
...
func (c *FakeRedisSentinels) Create(ctx context.Context, redisSentinel *v1beta2.RedisSentinel, opts v1.CreateOptions) (result *v1beta2.RedisSentinel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(redissentinelsResource, c.ns, redisSentinel), &v1beta2.RedisSentinel{})
...
func (c *FakeRedisSentinels) Update(ctx context.Context, redisSentinel *v1beta2.RedisSentinel, opts v1.UpdateOptions) (result *v1beta2.RedisSentinel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(redissentinelsResource, c.ns, redisSentinel), &v1beta2.RedisSentinel{})
...
func (c *FakeRedisSentinels) UpdateStatus(ctx context.Context, redisSentinel *v1beta2.RedisSentinel, opts v1.UpdateOptions) (*v1beta2.RedisSentinel, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(redissentinelsResource, "status", c.ns, redisSentinel), &v1beta2.RedisSentinel{})
...
func (c *FakeRedisSentinels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(redissentinelsResource, c.ns, name, opts), &v1beta2.RedisSentinel{})
...
func (c *FakeRedisSentinels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta2.RedisSentinelList{})
	return err
}
...
func (c *FakeRedisSentinels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.RedisSentinel, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(redissentinelsResource, c.ns, name, pt, data, subresources...), &v1beta2.RedisSentinel{})
