...
var redisclustersResource = v1beta2.SchemeGroupVersion.WithResource("redisclusters")

var redisclustersKind = v1beta2.SchemeGroupVersion.WithKind("RedisCluster")
...
func (c *FakeRedisClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.RedisCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(redisclustersResource, c.ns, name), &v1beta2.RedisCluster{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta2.RedisCluster), err
}
...
func (c *FakeRedisClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.RedisClusterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(redisclustersResource, redisclustersKind, c.ns, opts), &v1beta2.RedisClusterList{})
	...
	list := &v1beta2.RedisClusterList{ListMeta: obj.(*v1beta2.RedisClusterList).ListMeta}
	for _, item := range obj.(*v1beta2.RedisClusterList).Items {
...
func (c *FakeRedisClusters) Create(ctx context.Context, redisCluster *v1beta2.RedisCluster, opts v1.CreateOptions) (result *v1beta2.RedisCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(redisclustersResource, c.ns, redisCluster), &v1beta2.RedisCluster{})
...
func (c *FakeRedisClusters) Update(ctx context.Context, redisCluster *v1beta2.RedisCluster, opts v1.UpdateOptions) (result *v1beta2.RedisCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(redisclustersResource, c.ns, redisCluster), &v1beta2.RedisCluster{})
...
func (c *FakeRedisClusters) UpdateStatus(ctx context.Context, redisCluster *v1beta2.RedisCluster, opts v1.UpdateOptions) (*v1beta2.RedisCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(redisclustersResource, "status", c.ns, redisCluster), &v1beta2.RedisCluster{})
...
func (c *FakeRedisClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(redisclustersResource, c.ns, name, opts), &v1beta2.RedisCluster{})
...
func (c *FakeRedisClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta2.RedisClusterList{})
	return err
}
...
func (c *FakeRedisClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.RedisCluster, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(redisclustersResource, c.ns, name, pt, data, subresources...), &v1beta2.RedisCluster{})
