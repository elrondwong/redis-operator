...
func newRedisSentinels(c *V1beta2Client, namespace string) *redisSentinels {
...
func (c *redisSentinels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.RedisSentinel, err error) {
	result = &v1beta2.RedisSentinel{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *redisSentinels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.RedisSentinelList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.RedisSentinelList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redissentinels").
...
func (c *redisSentinels) Create(ctx context.Context, redisSentinel *v1beta2.RedisSentinel, opts v1.CreateOptions) (result *v1beta2.RedisSentinel, err error) {
	result = &v1beta2.RedisSentinel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("redissentinels").
...
func (c *redisSentinels) Update(ctx context.Context, redisSentinel *v1beta2.RedisSentinel, opts v1.UpdateOptions) (result *v1beta2.RedisSentinel, err error) {
	result = &v1beta2.RedisSentinel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redissentinels").
...
func (c *redisSentinels) UpdateStatus(ctx context.Context, redisSentinel *v1beta2.RedisSentinel, opts v1.UpdateOptions) (result *v1beta2.RedisSentinel, err error) {
	result = &v1beta2.RedisSentinel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("redissentinels").
...
func (c *redisSentinels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.RedisSentinel, err error) {
	result = &v1beta2.RedisSentinel{}
